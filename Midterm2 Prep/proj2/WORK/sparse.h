/* This is the header file for the sparse matrix project
   ...
   For Phase 1, you need to implement the following three functions in sparse.c. 
	...
	ROOT * addition (ROOT *M1, ROOT *M2, FILE *F);
								Gang Qu
								April 14, 2026
  Specification of addition() is updated 
  1. no need to print out the values of the sum insider this function call.
	In p2_1.c, show_list() is called to print out the sum.
  2. matrix at ... is rephrased 
								April 17, 2026
*/
...
ROOT * addition (ROOT *M1, ROOT *M2, FILE *F);
	...
	// matrix at 0x1afc610 + matrix at 0x18878d0 ...
		...
		// 1. print out the following message to F
	// matrix at 0x1887040 has k non-zero entries
		// where 0x1887040 is the address where the ROOT of the sum
		// M1+M2 is stored and k is the number of ENTRY's in the 
		// new linked list (M1+M2) of ENTRY's

		// 2. no need to print out the values of M1 + M2. This is done
		//	by the function call show_list() in p2_1.c.
